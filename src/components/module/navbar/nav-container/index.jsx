         ...
         <div className="flex flex-col gap-2">
            <div className="flex gap-4 w-60">
               ...
               <div className="relative h-10 w-full">
                  ...
                  <input
                     type="text"
                     className="w-full py-2 rounded-md border border-main-blue px-10"
                     placeholder="Coba cari Game"
                  />
               </div>
            </div>
            <div className="hidden lg:flex gap-1 text-[12px] text-main-fontlightgrey">
               {recomendations?.map(({ title, keywords }) => (
                  <p className="bg-main-buttonlightgrey p-1" key={keywords}>
                     {title}
                  </p>
               ))}
            </div>
